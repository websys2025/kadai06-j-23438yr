...
# e-Stat API用のアプリIDを指定
APP_ID = "5c6fdf80925ef0257303bb6f02ec1e274944a25f"   
API_URL = "http://api.e-stat.go.jp/rest/3.0/app/json/getStatsData" #URLでjson形式を指定

# ガス事業生産動態統計調査(2016年10～12月期)を指定
params = {
    "appId": APP_ID,
    "statsDataId": "0003225497",  
    "cdArea": "00000",           
    "metaGetFlg": "Y",
    "cntGetFlg": "N",
    "explanationGetFlg": "Y",
